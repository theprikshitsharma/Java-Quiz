...
public class LoginSignupScreen extends JFrame {
    ...
    public LoginSignupScreen() {
        ...
        // Login Panel
        JPanel loginPanel = createStyledPanel(background);
        ...
        // Note for the login panel about email being for sign-up
        JLabel loginNoteLabel = new JLabel("<html><i>Email is only required for new sign-ups</i></html>");
        loginNoteLabel.setForeground(Color.WHITE);
        loginPanel.add(loginNoteLabel);

        // Signup Panel
        JPanel signupPanel = createStyledPanel(background);
    ...
    private JPanel createStyledPanel(Color bg) {
        JPanel panel = new JPanel(new GridLayout(4, 2, 15, 15)); // Increased grid rows to accommodate email
